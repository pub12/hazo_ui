...
// Re-export types
export type { HazoUiTextareaProps, CommandTextOutput } from "./types";
 ...
 */
export const HazoUiTextarea: React.FC<HazoUiTextareaProps> = ({
  value,
  default_value,
  prefixes,
  ...
  const editor = useEditor({
    ...
    content: is_controlled
      ? multiline_text_to_tiptap_content(value || "", prefixes, pill_variant)
      : multiline_text_to_tiptap_content(default_value || "", prefixes, pill_variant),
    editable: !disabled,
